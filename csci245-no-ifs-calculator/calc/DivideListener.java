 ...
 * DivideListener
 *
 * Class to calculate the number by division
 *
...
public class DivideListener extends OperatorListener implements ActionListener {
	/**
	 ...
	 */
	public DivideListener(InternalState state) {
		super(state);
		this.state = state;
	}
