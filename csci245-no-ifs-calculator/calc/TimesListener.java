 ...
 * TimesListener
 *
 * Class to calculate the number by multiplication
 *
...
public class TimesListener extends OperatorListener implements ActionListener {
	/**
	 ...
	 */
	public TimesListener(InternalState state) {
		super(state);
		this.state = state;
	}
